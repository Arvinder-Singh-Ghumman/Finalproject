const listingsData = [{
  ...
  [Yesterday 12: 26 PM] Arshdeep Singh. {
  ...
  },
  {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image127.jpg", "path/to/image128.jpg"],
    category: "Retreat",
    price: 3200,
    location: "Mountain",
    reviews: {
      rating: 4.8,
      comments: ["Tranquil mountain escape!", "Perfect for hikers."],
    },
    seating: 6,
    description: "A secluded retreat tucked away in the mountains, offering peace and tranquility amidst nature.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1200,
    neighborhood: "Mountain Hideaway",
    squareFeet: 2000,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    title: "Charming Vineyard Cottage",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image129.jpg", "path/to/image130.jpg"],
    category: "Cottage",
    price: 2800,
    location: "Vineyard",
    reviews: {
      rating: 4.7,
      comments: ["Idyllic vineyard getaway!", "Scenic vineyard walks."],
    },
    seating: 4,
    description: "A charming cottage nestled in the vineyards, offering a cozy retreat amidst scenic surroundings.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1000,
    neighborhood: "Vineyard Cottage",
    squareFeet: 1600,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image131.jpg", "path/to/image132.jpg"],
    category: "Lodge",
    price: 4000,
    location: "Ski Resort",
    reviews: {
    ...
    seating: 12,
    description: "A luxurious mountain lodge with direct ski-in/ski-out access, perfect for winter sports enthusiasts.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1400,
    neighborhood: "Ski Lodge",
    squareFeet: 2800,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image133.jpg", "path/to/image134.jpg"],
    category: "Villa",
    price: 6000,
    location: "Oceanfront",
    reviews: {
      rating: 4.9,
      comments: ["Luxurious oceanfront retreat!", "Stunning sunset views."],
    },
    seating: 10,
    description: "A luxurious villa perched on the oceanfront, offering unparalleled luxury and breathtaking views.",
    term: "Long term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1800,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image135.jpg", "path/to/image136.jpg"],
    category: "Loft",
    price: 3500,
    location: "Downtown",
    reviews: {
      rating: 4.8,
      comments: ["Urban chic!", "Convenient city living."],
    },
    seating: 6,
    description: "A historic loft apartment in the heart of downtown, featuring stylish design and modern amenities.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1300,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image137.jpg", "path/to/image138.jpg"],
    category: "Villa",
    price: 4500,
    location: "Lakefront",
    reviews: {
      rating: 4.8,
      comments: ["Serene lakeside escape!", "Ideal for family vacations."],
    },
    seating: 8,
    description: "A tranquil villa nestled along the lakeshore, offering serene views and luxurious amenities.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1400,
    neighborhood: "Lakeside Villa",
    squareFeet: 2800,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image139.jpg", "path/to/image140.jpg"],
    category: "Lodge",
    price: 3000,
    location: "Forest",
    reviews: {
      rating: 4.7,
      comments: ["Escape to nature!", "Cozy fireside evenings."],
    },
    seating: 10,
    description: "A rustic lodge nestled in the forest, offering cozy accommodations and proximity to nature's wonders.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1200,
    neighborhood: "Forest Lodge",
    squareFeet: 2200,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    title: "Coastal Beachfront Retreat",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image141.jpg", "path/to/image142.jpg"],
    category: "Retreat",
    price: 3800,
    location: "Beachfront",
    reviews: {
      rating: 4.9,
      comments: ["Beachfront paradise!", "Relaxing coastal ambiance."],
    },
    seating: 8,
    description: "A coastal retreat situated directly on the beachfront, offering panoramic views and seaside serenity.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1500,
  ...
  },
  {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image143.jpg", "path/to/image144.jpg"],
    category: "Estate",
    price: 7000,
    location: "Hillside",
    reviews: {
      rating: 4.9,
      comments: ["Luxurious hillside retreat!", "Spectacular mountain views."],
    },
    seating: 12,
    description: "A luxurious estate perched on the hillside, offering opulent amenities and breathtaking mountain vistas.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1800,
    neighborhood: "Hillside Estate",
    squareFeet: 4000,
    hasParking: true,
    hasPublicTransportation: true,
  }, {
    title: "Tranquil Riverfront Cabin",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image145.jpg", "path/to/image146.jpg"],
    category: "Cabin",
    price: 2500,
    location: "Riverside",
    reviews: {
      rating: 4.7,
      comments: ["Serenity by the river!", "Perfect for fishing enthusiasts."],
    },
    seating: 6,
    description: "A tranquil cabin nestled along the riverside, offering peaceful views and riverside relaxation.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1100,
    neighborhood: "Riverfront Cabin",
    squareFeet: 1800,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image147.jpg", "path/to/image148.jpg"],
    category: "Chalet",
    price: 3500,
    location: "Mountain",
    reviews: {
      rating: 4.8,
      comments: ["Scenic mountain escape!", "Charming alpine ambiance."],
    },
    seating: 8,
    description: "A charming chalet with stunning mountain views, offering a cozy retreat in the heart of nature.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1300,
    neighborhood: "Mountain Chalet",
    squareFeet: 2200,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image149.jpg", "path/to/image150.jpg"],
    category: "Bungalow",
    price: 3200,
    location: "Beachfront",
    reviews: {
      rating: 4.8,
      comments: ["Sunny beachfront retreat!", "Relaxing coastal vibes."],
    },
    seating: 6,
    description: "A sunny bungalow nestled directly on the beachfront, offering a relaxing escape by the sea.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1200,
    neighborhood: "Beachfront Bungalow",
    squareFeet: 2000,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image151.jpg", "path/to/image152.jpg"],
    category: "Villa",
    price: 5000,
    location: "Mountain",
    reviews: {
      rating: 4.9,
      comments: ["Mountain luxury!", "Spectacular sunrise views."],
    },
    seating: 10,
    description: "A luxurious villa nestled in the mountains, offering opulent amenities and breathtaking views.",
    term: "Long term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1700,
    neighborhood: "Mountain Villa",
    squareFeet: 3000,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    title: "Seaside Cottage with Ocean Views",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image153.jpg", "path/to/image154.jpg"],
    category: "Cottage",
    price: 2800,
    location: "Seaside",
    reviews: {
      rating: 4.7,
      comments: ["Quaint seaside escape!", "Stunning coastal sunsets."],
    },
    seating: 6,
    description: "A charming seaside cottage with panoramic ocean views, offering a cozy coastal retreat.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: true,
    impressions: 1100,
    neighborhood: "Seaside Cottage",
    squareFeet: 1800,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image155.jpg", "path/to/image156.jpg"],
    category: "Cabin",
    price: 3000,
    location: "Riverside",
    reviews: {
      rating: 4.8,
      comments: ["Riverside relaxation!", "Inviting hot tub under the stars."],
    },
    seating: 6,
    description: "A cozy cabin nestled along the riverside, featuring a relaxing hot tub and scenic river views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1300,
    neighborhood: "Riverside Cabin",
    squareFeet: 2000,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image157.jpg", "path/to/image158.jpg"],
    category: "Chalet",
    price: 3800,
    location: "Mountain",
    reviews: {
      rating: 4.9,
      comments: ["Ski-in/ski-out luxury!", "Breathtaking alpine vistas."],
    },
    seating: 10,
    description: "A luxurious ski chalet with stunning mountain views, offering the ultimate winter getaway.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1400,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image159.jpg", "path/to/image160.jpg"],
    category: "Cabin",
    price: 2500,
    location: "Lakefront",
    reviews: {
      rating: 4.7,
      comments: ["Tranquility by the lake!", "Cozy fireside evenings."],
    },
    seating: 6,
    description: "A secluded cabin nestled by the lake, offering tranquility and relaxation in a picturesque setting.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1200,
    neighborhood: "Lakeside Cabin",
    squareFeet: 1800,
    hasParking: true,
    hasPublicTransportation: false,
  },
  {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image161.jpg", "path/to/image162.jpg"],
    category: "Cabin",
    price: 2800,
    location: "Lakefront",
    reviews: {
      rating: 4.8,
      comments: ["Cozy lakeside retreat!", "Perfect for fishing trips."],
    },
    seating: 6,
    description: "A rustic cabin nestled by the lake, offering cozy interiors and tranquil lakeside views.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1100,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image163.jpg", "path/to/image164.jpg"],
    category: "Mansion",
    price: 8000,
    location: "Beachfront",
    reviews: {
      rating: 4.9,
      comments: ["Exquisite beachfront estate!", "Private beach access."],
    },
    seating: 16,
    description: "A luxurious mansion overlooking the beach, offering opulent amenities and breathtaking ocean views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1800,
    neighborhood: "Beachfront Estates",
    squareFeet: 10000,
    hasParking: true,
    hasPublicTransportation: true,
  }, {
    title: "Tranquil Countryside Cottage",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image165.jpg", "path/to/image166.jpg"],
    category: "Cottage",
    price: 3000,
    location: "Countryside",
    reviews: {
      rating: 4.7,
      comments: ["Peaceful countryside escape!", "Idyllic rural setting."],
    },
    seating: 6,
    description: "A tranquil cottage nestled in the countryside, offering serene views and a peaceful ambiance.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1200,
    neighborhood: "Countryside Cottage",
    squareFeet: 1800,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image167.jpg", "path/to/image168.jpg"],
    category: "Penthouse",
    price: 5500,
    location: "City Center",
    reviews: {
      rating: 4.9,
      comments: ["Urban sophistication!", "Panoramic city skyline views."],
    },
    seating: 8,
    description: "An elegant penthouse in the heart of the city, offering luxurious living spaces and stunning city views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1600,
    neighborhood: "City Penthouse",
    squareFeet: 2500,
    hasParking: true,
    hasPublicTransportation: true,
  }, {
    title: "Serenity by the River",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image169.jpg", "path/to/image170.jpg"],
    category: "House",
    price: 4500,
    location: "Riverside",
    reviews: {
      rating: 4.8,
      comments: ["Tranquil riverside retreat!", "Relaxing riverfront ambiance."],
    },
    seating: 10,
    description: "A serene house nestled along the riverside, offering peaceful views and a tranquil atmosphere.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1400,
    ...
    title: "Cozy Countryside Chalet",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image171.jpg", "path/to/image172.jpg"],
    category: "Chalet",
    price: 3200,
    location: "Countryside",
    reviews: {
      rating: 4.7,
      comments: ["Cozy countryside getaway!", "Charming rural retreat."],
    },
    seating: 6,
    description: "A cozy chalet nestled in the countryside, offering warmth and comfort in a picturesque setting.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1100,
    neighborhood: "Countryside Chalet",
    squareFeet: 2000,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image173.jpg", "path/to/image174.jpg"],
    category: "Retreat",
    price: 3800,
    location: "Seaside",
    reviews: {
      rating: 4.9,
      comments: ["Seaside paradise!", "Private pool with ocean views."],
    },
    seating: 8,
    description: "A serene seaside retreat with a private pool, offering relaxation and oceanfront views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1500,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image175.jpg", "path/to/image176.jpg"],
    category: "Retreat",
    price: 3400,
    location: "Mountain",
    reviews: {
      rating: 4.8,
      comments: ["Scenic mountain getaway!", "Tranquil alpine setting."],
    },
    seating: 8,
    description: "A peaceful retreat with stunning mountain views, offering relaxation and natural beauty.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1300,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image177.jpg", "path/to/image178.jpg"],
    category: "House",
    price: 4200,
    location: "Riverside",
    reviews: {
      rating: 4.9,
      comments: ["Idyllic riverside escape!", "Tranquil riverfront living."],
    },
    seating: 8,
    description: "An idyllic house nestled along the riverside, offering tranquility and scenic river views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1600,
    neighborhood: "Riverside Paradise",
    squareFeet: 2600,
    hasParking: true,
    hasPublicTransportation: false,
  },
  {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image181.jpg", "path/to/image182.jpg"],
    category: "Apartment",
    price: 3800,
    location: "City Center",
    reviews: {
      rating: 4.8,
      comments: ["Urban living at its finest!", "Convenient city lifestyle."],
    },
    seating: 6,
    description: "A modern apartment in the heart of the city, featuring sleek design and urban convenience.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1400,
    neighborhood: "City Apartment",
    squareFeet: 2000,
    hasParking: true,
    hasPublicTransportation: true,
  }, {
    title: "Tranquil Forest Retreat",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image183.jpg", "path/to/image184.jpg"],
    category: "Retreat",
    price: 3200,
    location: "Forest",
    reviews: {
      rating: 4.7,
      comments: ["Escape to nature!", "Peaceful forest surroundings."],
    },
    seating: 8,
    description: "A tranquil retreat nestled in the forest, offering relaxation and immersion in nature's beauty.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1200,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image185.jpg", "path/to/image186.jpg"],
    category: "Cabin",
    price: 2600,
    location: "Lakefront",
    reviews: {
      rating: 4.8,
      comments: ["Cozy lakeside getaway!", "Rustic charm."],
    },
    seating: 6,
    description: "A charming log cabin nestled by the lake, offering cozy interiors and scenic lakeside views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: true,
    impressions: 1100,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image187.jpg", "path/to/image188.jpg"],
    category: "Retreat",
    price: 3600,
    location: "Mountain",
    reviews: {
      rating: 4.9,
      comments: ["Mountain bliss!", "Relaxing hot tub under the stars."],
    },
    seating: 8,
    description: "A peaceful mountain retreat with a private hot tub, offering relaxation and stunning alpine views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1500,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image189.jpg", "path/to/image190.jpg"],
    category: "Cottage",
    price: 3000,
    location: "Countryside",
    reviews: {
      rating: 4.7,
      comments: ["Peaceful countryside retreat!", "Idyllic rural charm."],
    },
    seating: 6,
    description: "A secluded cottage nestled in the countryside, offering peace and tranquility amidst natural beauty.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1200,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image191.jpg", "path/to/image192.jpg"],
    category: "Estate",
    price: 7000,
    location: "Lakefront",
    reviews: {
      rating: 4.9,
      comments: ["Lakefront luxury!", "Exquisite lakeside living."],
    },
    seating: 12,
    description: "A luxurious estate perched on the lakeshore, offering opulent amenities and breathtaking views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1800,
    neighborhood: "Lakeside Estate",
    squareFeet: 4000,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    title: "Seaside Villa with Infinity Pool",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image193.jpg", "path/to/image194.jpg"],
    category: "Villa",
    price: 6000,
    location: "Seaside",
    reviews: {
      rating: 4.9,
      comments: ["Seaside paradise!", "Infinity pool with ocean views."],
    },
    seating: 10,
    description: "A luxurious seaside villa with an infinity pool, offering relaxation and stunning ocean vistas.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1700,
    neighborhood: "Seaside Villa",
    squareFeet: 3200,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image195.jpg", "path/to/image196.jpg"],
    category: "Chalet",
    price: 3400,
    location: "Mountain",
    reviews: {
      rating: 4.8,
      comments: ["Scenic mountain escape!", "Cozy alpine ambiance."],
    },
    seating: 6,
    description: "A charming chalet nestled in the mountains, offering warmth and comfort amidst stunning natural beauty.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1300,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image197.jpg", "path/to/image198.jpg"],
    category: "Cabin",
    price: 2800,
    location: "Riverside",
    reviews: {
      rating: 4.7,
      comments: ["Riverside charm!", "Cozy log cabin living."],
    },
    seating: 6,
    description: "A charming log cabin nestled along the riverside, offering cozy interiors and scenic river views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: true,
    impressions: 1200,
    ...
    title: "Coastal Retreat with Private Beach",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image199.jpg", "path/to/image200.jpg"],
    category: "Retreat",
    price: 4200,
    location: "Coastal",
    reviews: {
      rating: 4.9,
      comments: ["Coastal paradise!", "Exclusive access to private beach."],
    },
    seating: 8,
    description: "A serene coastal retreat with a private beach, offering relaxation and breathtaking ocean views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1500,
  ...
  {
    title: "Luxury Lakeside Lodge",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image201.jpg", "path/to/image202.jpg"],
    category: "Lodge",
    price: 6000,
    location: "Lakefront",
    reviews: {
      rating: 4.9,
      comments: ["Exquisite lakeside retreat!", "Ultimate luxury by the lake."],
    },
    seating: 12,
    description: "A luxurious lodge nestled on the lakeshore, offering unparalleled amenities and stunning lake views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1800,
    neighborhood: "Lakeside Lodge",
    squareFeet: 4500,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image203.jpg", "path/to/image204.jpg"],
    category: "Cabin",
    price: 2800,
    location: "Mountain",
    reviews: {
      rating: 4.7,
      comments: ["Cozy mountain getaway!", "Rustic charm in the wilderness."],
    },
    seating: 6,
    description: "A rustic cabin tucked away in the mountains, offering cozy interiors and scenic mountain views.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1100,
    neighborhood: "Mountain Cabin",
    squareFeet: 1800,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    title: "Oceanfront Retreat with Pool",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image205.jpg", "path/to/image206.jpg"],
    category: "Retreat",
    price: 4500,
    location: "Oceanfront",
    reviews: {
      rating: 4.8,
      comments: ["Oceanfront paradise!", "Private pool with ocean views."],
    },
    seating: 8,
    description: "A luxurious oceanfront retreat with a private pool, offering relaxation and panoramic ocean vistas.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1500,
    ...
    title: "Secluded Forest Cabin",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image207.jpg", "path/to/image208.jpg"],
    category: "Cabin",
    price: 2600,
    location: "Forest",
    reviews: {
      rating: 4.7,
      comments: ["Tranquil forest retreat!", "Secluded wilderness hideaway."],
    },
    seating: 6,
    description: "A secluded cabin nestled in the forest, offering peace and tranquility amidst natural beauty.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1200,
    neighborhood: "Forest Cabin",
    squareFeet: 1800,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    title: "Coastal Cottage with Sea Views",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image209.jpg", "path/to/image210.jpg"],
    category: "Cottage",
    price: 3200,
    location: "Coastal",
    reviews: {
      rating: 4.8,
      comments: ["Charming coastal getaway!", "Panoramic sea views."],
    },
    seating: 6,
    description: "A charming coastal cottage with panoramic sea views, offering a relaxing escape by the coast.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: true,
    impressions: 1300,
    neighborhood: "Coastal Cottage",
    squareFeet: 2000,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    title: "Mountain Chalet with Jacuzzi",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image211.jpg", "path/to/image212.jpg"],
    category: "Chalet",
    price: 3600,
    location: "Mountain",
    reviews: {
      rating: 4.9,
      comments: ["Scenic mountain retreat!", "Relaxing jacuzzi with mountain views."],
    },
    seating: 8,
    description: "A cozy mountain chalet with a relaxing jacuzzi, offering comfort and stunning mountain vistas.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1400,
    ...
    title: "Riverfront Haven with Deck",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image213.jpg", "path/to/image214.jpg"],
    category: "House",
    price: 3800,
    location: "Riverside",
    reviews: {
      rating: 4.9,
      comments: ["Idyllic riverside escape!", "Spacious deck overlooking the river."],
    },
    seating: 8,
    description: "A riverside house with a spacious deck, offering relaxation and beautiful river views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1600,
    neighborhood: "Riverfront Haven",
    squareFeet: 2600,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    title: "Seaside Chalet with Beach Access",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image215.jpg", "path/to/image216.jpg"],
    category: "Chalet",
    price: 3800,
    location: "Seaside",
    reviews: {
      rating: 4.9,
      comments: ["Seaside luxury!", "Direct beach access."],
    },
    seating: 8,
    description: "A luxurious seaside chalet with direct beach access, offering relaxation and coastal charm.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1700,
    neighborhood: "Seaside Chalet",
    squareFeet: 2400,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    title: "Mountain View Cabin with Fireplace",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image217.jpg", "path/to/image218.jpg"],
    category: "Cabin",
    price: 3000,
    location: "Mountain",
    reviews: {
      rating: 4.8,
      comments: ["Scenic mountain retreat!", "Cozy fireplace evenings."],
    },
    seating: 6,
    description: "A charming cabin with stunning mountain views and a cozy fireplace, offering warmth and relaxation.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1400,
  ...
  },
  {
    title: "Secluded Mountain Retreat",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image219.jpg", "path/to/image220.jpg"],
    category: "Retreat",
    price: 3800,
    location: "Mountain",
    reviews: {
      rating: 4.9,
      comments: ["Tranquil mountain escape!", "Serene natural surroundings."],
    },
    seating: 8,
    description: "A secluded retreat nestled in the mountains, offering peace and tranquility amidst stunning natural scenery.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1600,
    ...
    title: "Cozy Coastal Bungalow",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image221.jpg", "path/to/image222.jpg"],
    category: "Bungalow",
    price: 3000,
    location: "Coastal",
    reviews: {
      rating: 4.7,
      comments: ["Charming coastal getaway!", "Relaxing seaside ambiance."],
    },
    seating: 4,
    description: "A cozy bungalow near the coast, offering relaxation and coastal charm in a tranquil setting.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1300,
    neighborhood: "Coastal Bungalow",
    squareFeet: 1600,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    title: "Riverfront Retreat with Kayaks",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image223.jpg", "path/to/image224.jpg"],
    category: "Retreat",
    price: 4200,
    location: "Riverside",
    reviews: {
      rating: 4.8,
      comments: ["Scenic riverside escape!", "Kayaking adventures on the river."],
    },
    seating: 8,
    description: "A riverside retreat with kayaks available, offering relaxation and outdoor adventures by the river.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1700,
    ...
    title: "Ski-in/Ski-out Chalet",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image225.jpg", "path/to/image226.jpg"],
    category: "Chalet",
    price: 4000,
    location: "Mountain",
    reviews: {
      rating: 4.9,
      comments: ["Ultimate ski getaway!", "Convenient slope-side location."],
    },
    seating: 10,
    description: "A luxurious chalet with ski-in/ski-out access, offering the ultimate convenience for winter sports enthusiasts.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1800,
    neighborhood: "Ski Chalet",
    squareFeet: 2800,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image227.jpg", "path/to/image228.jpg"],
    category: "Retreat",
    price: 3600,
    location: "Lakefront",
    reviews: {
      rating: 4.8,
      comments: ["Peaceful lakeside escape!", "Tranquil evenings by the lake."],
    },
    seating: 8,
    description: "A tranquil retreat by the lake, offering relaxation and breathtaking views of the water.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: true,
    impressions: 1500,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image229.jpg", "path/to/image230.jpg"],
    category: "Villa",
    price: 5500,
    location: "Beachfront",
    reviews: {
      rating: 4.9,
      comments: ["Beachfront luxury!", "Spectacular sunsets over the ocean."],
    },
    seating: 10,
    description: "A luxurious villa on the beachfront, offering sun-soaked days and stunning ocean views.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1900,
    ...
    title: "Serenity Cottage by the River",
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image231.jpg", "path/to/image232.jpg"],
    category: "Cottage",
    price: 3200,
    location: "Riverside",
    reviews: {
      rating: 4.7,
      comments: ["Peaceful riverside retreat!", "Tranquil river views."],
    },
    seating: 6,
    description: "A serene cottage nestled by the river, offering peace and tranquility amidst natural beauty.",
    term: "Long term",
    availability: "Upcoming",
    isSmokingAllowed: true,
    impressions: 1300,
    neighborhood: "Riverside Cottage",
    squareFeet: 2000,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image233.jpg", "path/to/image234.jpg"],
    category: "House",
    price: 4800,
    location: "Seaside",
    reviews: {
      rating: 4.9,
      comments: ["Beachfront bliss!", "Direct access to sandy shores."],
    },
    seating: 10,
    description: "A charming beach house with direct access to the sandy shores, offering relaxation and coastal charm.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1700,
    neighborhood: "Seaside Beach House",
    squareFeet: 3000,
    hasParking: true,
    hasPublicTransportation: false,
  }, {
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image235.jpg", "path/to/image236.jpg"],
    category: "Cabin",
    price: 3400,
    location: "Mountain",
    reviews: {
      rating: 4.8,
      comments: ["Scenic mountain retreat!", "Relaxing hot tub under the stars."],
    },
    seating: 6,
    description: "A cozy cabin with stunning mountain views and a relaxing hot tub, offering warmth and relaxation.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1400,
    ...
    owner: "609c58d74f4e123456789abc",
    picturePath: ["path/to/image237.jpg", "path/to/image238.jpg"],
    category: "Chalet",
    price: 4200,
    location: "Mountain",
    reviews: {
      rating: 4.9,
      comments: ["Cosy ski retreat!", "Warm fireplace after a day on the slopes."],
    },
    seating: 8,
    description: "A charming ski chalet with a warm fireplace, offering comfort and relaxation after a day of skiing.",
    term: "Short term",
    availability: "Available now",
    isSmokingAllowed: false,
    impressions: 1600,
